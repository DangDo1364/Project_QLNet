...
public class ClientGUI extends JFrame {
    ...
    public static JTextField inputPort;
	...
	contentPane = new JPanel();
        contentPane.setBackground(new java.awt.Color(189,231,253));
	...
	if (lblIp == null) {
	    lblIp = new JLabel("IP ");
	    lblIp.setFont(new Font("Tahoma", Font.PLAIN, 21));
	...
	if (lblPort == null) {
	    ...
	    lblPort.setFont(new Font("Tahoma", Font.PLAIN, 21));
	    lblPort.setBounds(450, 13, 131, 51);
	}
	return lblPort;
    }
	...
	if (lblNewLabel_1 == null) {
	    lblNewLabel_1 = new JLabel("VUI LÒNG CLICK VÀO CONNECT NHẬP 'batdau' VÀ GỬI ĐỂ GỬI KHỞI ĐỘNG");
	...
	if (lblNewLabel_2 == null) {
	    lblNewLabel_2 = new JLabel("TIỆM NET DVD");
